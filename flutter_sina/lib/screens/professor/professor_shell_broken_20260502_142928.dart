...
class _ProfessorShellState extends State<ProfessorShell> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<_ProfessorTab> tabs = <_ProfessorTab>[
      ...
      _ProfessorTab(
        keyName: 'exams',
        label: isRtlLang(lang) ? 'امتحانات' : 'Exams',
        icon: Icons.quiz_outlined,
        activeIcon: Icons.quiz,
        page: const _ProfessorExamsPage(),
      ),
      _ProfessorTab(
        keyName: 'more',
...
class _ProfessorExamsPage extends StatelessWidget {
  const _ProfessorExamsPage();

  @override
  Widget build(BuildContext context) {
    return const ProfessorExamsScreen();
  }
}
